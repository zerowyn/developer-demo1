...
import com.eg.egsc.scp.demo.service.impl.DemoServiceImpl;
...
//	@Test
	...
	public void countByExample() {
		...
		example.createCriteria().andCreateUserIsNull();
		int userCount = demoService.countByExample(example);
		String s = JsonUtil.toJsonString(userCount);
	}
  ...
  public void getAllUser() {
    ...
    List<DemoUser> userList = demoService.getAllUser();
	  String s = JsonUtil.toJsonString(userList);
	  logger.info(s);
  }
  @Test
  ...
  @Test
  public void getUser() {
    JsonUtil.toJsonString(demoService.getUser("67832002"));
  }
  @Test

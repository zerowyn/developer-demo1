 ...
 */
package com.eg.egsc.scp.demo.client.impl;
...
import com.eg.egsc.scp.demo.client.DemoUserClient;
...
public class DemoUserClientImpl extends BaseApiClient implements DemoUserClient {
  ...
  /* (non-Javadoc)
   * @see com.eg.egsc.scp.demo.client.DemoUserClient#createUser(com.eg.egsc.scp.demo.dto.UserDto)
   */
  @Override
 ...
 /* (non-Javadoc)
 * @see com.eg.egsc.scp.demo.client.DemoUserClient#deleteUser(com.eg.egsc.scp.demo.dto.UserDto)
 */
@Override
  public void deleteUser(UserDto userDto) throws CommonException {
	...
	/* (non-Javadoc)
	 * @see com.eg.egsc.scp.demo.client.DemoUserClient#updateUser(com.eg.egsc.scp.demo.dto.UserDto)
	 */
	@Override
  public void updateUser(UserDto userDto) throws CommonException {
	...
	/* (non-Javadoc)
	 * @see com.eg.egsc.scp.demo.client.DemoUserClient#selectUser(com.eg.egsc.scp.demo.dto.UserDto)
	 */
	@Override
  public UserDto selectUser(UserDto userDto) throws CommonException {
	...
	/* (non-Javadoc)
	 * @see com.eg.egsc.scp.demo.client.DemoUserClient#getUserList(com.eg.egsc.scp.demo.dto.UserDto)
	 */
	@Override
